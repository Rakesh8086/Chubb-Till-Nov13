...
public class FundTransfer {
    ...
    //  }
      ...
      Customer c1 = new Customer("James","james@gmail.com","43432432442", 40000.00);
      
      Customer c2 = new Customer("Robin","robin@gmail.com","43432432441",50000.00);
   ...
   //   obj.processFund(c1,c2,4000); 
      ...
      if(isValidCustomer) {
     try {
		neftobj.processFund(c1, c2, 30000.00);
	} catch (Exception e) {
